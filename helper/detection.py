...
from helper.base_utils import Color, Rect
...
def match_detections_with_tracks(
    ...
    for tracker_index, detection_index in enumerate(track2detection):
        if iou[tracker_index, detection_index] != 0:
            if detections[detection_index].class_name == "referee":
              detections[detection_index].tracker_id = "REF"
            elif detections[detection_index].class_name == "goalkeeper":
              detections[detection_index].tracker_id = "GK"+str(tracks[tracker_index].track_id)
            else:
              detections[detection_index].tracker_id = "P"+str(tracks[tracker_index].track_id)
    return detections
